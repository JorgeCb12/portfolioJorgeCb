...
const AboutMeBlock = ({ className }) => {
  return (
    <GlassCard
      className={`flex flex-col justify-between gap-6 p-6 ${className}`}
    >
      <div className="flex flex-col h-full justify-between">
        ...
        <div className="flex flex-col gap-4">
          <p className="text-gray-300 text-sm leading-relaxed">
            ...
            <span className="text-purple-400">modernas y atractivas</span>{" "}
            (React, Tailwind).
          </p>

          <p className="text-gray-300 text-sm leading-relaxed">
            Me apasiona resolver desafíos complejos y estoy comprometido 100%
            con escribir código{" "}
