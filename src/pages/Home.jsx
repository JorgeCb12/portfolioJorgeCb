  ...
  return (
    <div className="min-h-screen bg-slate-950 relative w-full overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-1 container mx-auto xl:max-w-[1600px] lg:max-w-[1200px] md:grid-cols-2 lg:grid-cols-12 xl:grid-cols-12 gap-4 relative z-30 p-4 md:p-8 pointer-events-none">
        <HeroBlock className="col-span-1 md:col-span-1 lg:col-span-4 xl:col-span-4 row-span-1 xl:row-span-1 h-full p-6" />

        <StackBlock className="col-span-1 md:col-span-1 lg:col-span-4 xl:col-span-4 row-span-1 h-full p-4" />
        ...
        <ExperienceBlock className="col-span-1 md:col-span-1 lg:col-span-4 xl:col-span-5 row-span-1 xl:row-span-1 h-full p-2" />

        <ContactBlock className="col-span-1 md:col-span-1 lg:col-span-4 xl:col-span-3 row-span-1 h-full p-2" />
      </div>
    </div>
  );
};
